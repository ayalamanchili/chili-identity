...
public class ReadAllEndProjectPanel extends CRUDReadAllComposite {
    ...
    public void fillData(JSONArray entities) {
        for (int i = 1; i <= entities.size(); i++) {
            ...
            JSONObject recruiters = (JSONObject) entity.get("recruiters");
            table.setText(i, 1, JSONUtils.toString(emp, "firstName")+" "+JSONUtils.toString(emp, "lastName"));
            table.setText(i, 2, JSONUtils.toString(recruiters, "firstName")+" "+JSONUtils.toString(recruiters, "lastName"));
