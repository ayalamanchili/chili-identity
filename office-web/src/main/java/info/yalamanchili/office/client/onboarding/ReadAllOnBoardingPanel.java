 ...
 */
public class ReadAllOnBoardingPanel extends CRUDReadAllComposite {

    private static Logger logger = Logger.getLogger(ReadAllOnBoardingPanel.class.getName());
    public static ReadAllOnBoardingPanel instance;
    protected String url;

    public ReadAllOnBoardingPanel() {
        instance = this;
        initTable("InitiateOnBoarding", OfficeWelcome.constants);
    }

    public ReadAllOnBoardingPanel(JSONArray array) {
        instance = this;
        initTable("InitiateOnBoarding", array, OfficeWelcome.constants);
    }
    ...
    public void fillData(JSONArray entities) {
        for (int i = 1; i <= entities.size(); i++) {
            ...
            table.setText(i, 2, JSONUtils.toString(emp, "employeeType"));
    ...
    private String getReadAllExpenseReportURL(Integer start, String tableSize) {
        ...
        return OfficeWelcome.constants.root_url() + "admin/on-board-employee" + start.toString() + "/" + tableSize.toString();
    }
