 ...
 * @author Prashanthi
 */
public class SearchSkillpanel extends SearchComposite {

    private static Logger logger = Logger.getLogger(SearchSkillpanel.class.getName());

    public SearchSkillpanel() {
        init("Skill Search", "Skill", OfficeWelcome.constants);
    }
    ...
    protected String getSearchURI(Integer start, Integer limit) {
        return OfficeWelcome.constants.root_url() + "skill/search/" + start.toString() + "/"
                + limit.toString();
    }
}
