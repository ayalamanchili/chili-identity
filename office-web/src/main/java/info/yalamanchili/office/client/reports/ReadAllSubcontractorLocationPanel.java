 ...
 */
public class ReadAllSubcontractorLocationPanel extends CRUDReadAllComposite {

    private static Logger logger = Logger.getLogger(ReadAllSubcontractorLocationPanel.class.getName());
    public static ReadAllSubcontractorLocationPanel instance;

    public ReadAllSubcontractorLocationPanel(JSONArray array) {
        instance = this;
    ...
    public void createTableHeader() {
        ...
        table.setText(0, 1, getKeyValue("Subcontractor"));
