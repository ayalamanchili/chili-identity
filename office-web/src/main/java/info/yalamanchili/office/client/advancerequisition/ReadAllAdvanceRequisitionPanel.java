...
public class ReadAllAdvanceRequisitionPanel extends CRUDReadAllComposite {
    ...
    public void createTableHeader() {
        ...
        table.setText(0, 1, getKeyValue("Amount"));
        table.setText(0, 2, getKeyValue("NeededBy"));
        table.setText(0, 3, getKeyValue("DateRequested"));
        table.setText(0, 4, getKeyValue("PayrollFileNumber"));
        table.setText(0, 5, getKeyValue("transaction"));
    }
    ...
    public void fillData(JSONArray entities) {
        for (int i = 1; i <= entities.size(); i++) {
            ...
            table.setText(i, 1, JSONUtils.toString(entity, "amount"));
            table.setText(i, 2, JSONUtils.toString(entity, "neededBy"));
            table.setText(i, 3, JSONUtils.toString(entity, "dateRequested"));
            table.setText(i, 4, JSONUtils.toString(entity, "payrollFileNumber"));
            table.setText(i, 5, JSONUtils.toString(entity, "transaction"));
        }
    }
