 ...
 * @author Prashanthi
 */
public class UpdateTechnologyGroupPanel extends UpdateComposite {

    private static Logger logger = Logger.getLogger(UpdateTechnologyGroupPanel.class.getName());
    ...
    public UpdateTechnologyGroupPanel(JSONObject entity) {
        logger.info("ddddd" + entity);
        initUpdateComposite(entity, "TechnologyGroup", OfficeWelcome.constants);
    }
