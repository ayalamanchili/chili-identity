 ...
 * @author prasanthi.p
 */
public class ConsultantEmpLeaveRequestCancelPanel extends ALComposite implements ClickHandler {

    protected String timeSheetId;
    protected FlowPanel panel = new FlowPanel();
    TextAreaField cancelReasonF = new TextAreaField(OfficeWelcome.constants, "cancel", "ConsultantEmpLeaveRequest", false, true);
    Button cancelB = new Button("Cancel");

    public ConsultantEmpLeaveRequestCancelPanel(String timeSheetId) {
