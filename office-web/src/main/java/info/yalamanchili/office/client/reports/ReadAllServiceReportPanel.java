 ...
 */
public class ReadAllServiceReportPanel extends CRUDReadAllComposite {
    
    private static Logger logger = Logger.getLogger(ReadAllServiceReportPanel.class.getName());
    public static ReadAllServiceReportPanel instance;

    public ReadAllServiceReportPanel(JSONArray array) {
        instance = this;
