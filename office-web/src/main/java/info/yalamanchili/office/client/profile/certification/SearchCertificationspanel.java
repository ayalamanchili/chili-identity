...
public class SearchCertificationspanel extends SearchComposite {
    ...
    protected void postSearchSuccess(JSONArray result) {
        ...
        TabPanel.instance().recruitingPanel.entityPanel.add(new ReadAllCertificationsPanel(result));
    }

    @Override
    protected String getSearchURI(String searchText, Integer start, Integer limit) {
        return OfficeWelcome.constants.root_url() + "certification/search/" + searchText + "/" + start.toString() + "/"
                + limit.toString();
    }
