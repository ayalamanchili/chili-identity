...
public class ReadContractsPanel extends TReadComposite {
    ...
    protected void addWidgets() {
        ...
        addField("clientAPContact", true, false, DataType.RICH_TEXT_AREA, Alignment.HORIZONTAL, 5, 2);
        addField("vendor", true, false, DataType.STRING_FIELD, Alignment.HORIZONTAL, 6, 1);
        addField("vendorLocation", true, false, DataType.STRING_FIELD, Alignment.HORIZONTAL, 6, 2);
        addField("vendorContact", true, false, DataType.RICH_TEXT_AREA, Alignment.HORIZONTAL, 7, 1);
        addField("vendorAPContact", true, false, DataType.RICH_TEXT_AREA, Alignment.HORIZONTAL, 7, 2);
        addField("vendorPaymentTerms", true, false, DataType.RICH_TEXT_AREA, Alignment.HORIZONTAL, 8, 1);
        addField("vendorRecruiter", true, false, DataType.RICH_TEXT_AREA, Alignment.HORIZONTAL, 8, 2);
        addField("middleVendor", true, false, DataType.STRING_FIELD, Alignment.HORIZONTAL, 9, 1);
        addField("recruiter", true, false, DataType.STRING_FIELD, Alignment.HORIZONTAL, 9, 2);
        addField("clientProject", true, false, DataType.STRING_FIELD, Alignment.HORIZONTAL, 10, 1);
        addField("purchaseOrderNo", true, false, DataType.STRING_FIELD, Alignment.HORIZONTAL, 10, 2);
        addField("startDate", true, false, DataType.DATE_FIELD, Alignment.HORIZONTAL, 11, 1);
        addField("endDate", true, false, DataType.DATE_FIELD, Alignment.HORIZONTAL, 11, 2);
