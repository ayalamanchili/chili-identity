...
public class ReadAllContractsPanel extends CRUDReadAllComposite {
    ...
    public void createTableHeader() {
        ...
        table.setText(0, 7, getKeyValue("Employee"));
    }
    ...
    public void fillData(JSONArray entities) {
        for (int i = 1; i <= entities.size(); i++) {
            ...
            table.setText(i, 7, JSONUtils.toString(entity, "employee"));
        }
    }
    ...
    protected void addOptionsWidget(int row, JSONObject entity) {
        ...
        } else if (Auth.hasAnyOfRoles(Auth.ROLE.ROLE_ADMIN, Auth.ROLE.ROLE_HR, Auth.ROLE.ROLE_RELATIONSHIP)) {
