...
public class ReadAllClientReportPanel extends CRUDReadAllComposite {
    ...
    public ReadAllClientReportPanel() {
        instance = this;
    ...
    public ReadAllClientReportPanel(String parentId) {
        instance = this;
    ...
    public void createTableHeader() {
        ...
        table.setText(0, 7, getKeyValue("SubContractor"));
        table.setText(0, 8, getKeyValue("SubContractorPayRate"));
