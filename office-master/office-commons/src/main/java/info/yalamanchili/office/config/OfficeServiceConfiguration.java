...
public class OfficeServiceConfiguration {
     ...
     */
    protected String errorLogsEmailList = "yphanikumar@gmail.com,prasanthi.p@sstech.mobi,anu@yalamanchili.info,radhika.mukkala@sstech.us,Madhu.Badiginchala@sstech.us,Kiranmai.Ramisetti@sstech.us,Ramana.Lukalapu@sstech.us,hemalatha.duggirala@sstech.us";
    /**
