 ...
 */
public class ProspectFinalEmailEscalation implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        for (org.activiti.engine.task.Task task : query.list()) {
            ...
            email.addTos(MailUtils.instance().getEmailsAddressesForRoles(OfficeRoles.OfficeRole.ROLE_CEO.name()));
