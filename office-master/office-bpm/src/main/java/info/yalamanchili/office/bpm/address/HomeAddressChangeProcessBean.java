...
public class HomeAddressChangeProcessBean {
    ...
    public void sendAddressChangeRequestEEMNotificationEmail(Address address) {
        ...
        email.setSubject("Employee " + address.getContact().getFirstName() + " " + address.getContact().getLastName() + " Home/Priimary Email Address has been updated");
        email.setBody("Employee " + address.getContact().getFirstName() + " " + address.getContact().getLastName() + " Home/Priimary Email Address has been updated");
