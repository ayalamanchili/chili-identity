...
@Table(
        ...
        indexes = {
            @Index(name = "USR_NM", columnList = "username"),
            @Index(name = "USR_PWD", columnList = "passwordHash")})
...
public class CUser implements Serializable {
    ...
    public CUser(String username, String passwordHash, boolean enabled, CRole... roles) {
        this.username = username;
        this.passwordHash = passwordHash;
    ...
    @JoinTable(name = "UserRoles", joinColumns
            ...
            = @JoinColumn(name = "RoleId"), foreignKey = @ForeignKey(name = "FK_CRoles_CUsers"))
    @XmlTransient
    ...
    public String toString() {
        return "CUser{" + "userId=" + userId + ", username=" + username + ", passwordHash=" + passwordHash + ", enabled=" + enabled + ", locked=" + locked + ", roles=" + roles + '}';
    }
