...
public class _jet_readall_listxml_0 implements JET2Template {

    public _jet_readall_listxml_0() {
        super();
    }
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write(NL);         
        out.write("    android:id=\"@+id/readall_list_item_one\"");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write("  <TextView");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    android:id=\"@+id/readall_list_item_two\"");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    android:layout_width=\"fill_parent\"");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    android:layout_height=\"fill_parent\"  ");  //$NON-NLS-1$        
        ...
        out.write("  ");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    android:layout_alignParentLeft=\"@+id/readall_item_one\"");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("  />");  //$NON-NLS-1$        
        out.write(NL);         
