...
public class _jet_read_all_abstractjava implements JET2Template {
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$
    private static final String _jetns_f = "org.eclipse.jet.formatTags"; //$NON-NLS-1$
    private static final String _jetns_java = "org.eclipse.jet.javaTags"; //$NON-NLS-1$

    public _jet_read_all_abstractjava() {
        super();
    }
    ...
    private static final TagInfo _td_c_if_237_1 = new TagInfo("c:if", //$NON-NLS-1$
            237, 1,
            new String[] {
                "test", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_f_message_238_1 = new TagInfo("f:message", //$NON-NLS-1$
            238, 1,
            new String[] {
            },
            new String[] {
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        while (_jettag_java_format_2_1.okToProcessBody()) {
            ...
            while (_jettag_f_bundle_3_1.okToProcessBody()) {
                ...
                out.write("\t}");  //$NON-NLS-1$        
                out.write(NL);         
                RuntimeTagElement _jettag_c_if_237_1 = context.getTagFactory().createRuntimeTag(_jetns_c, "if", "c:if", _td_c_if_237_1); //$NON-NLS-1$ //$NON-NLS-2$
                _jettag_c_if_237_1.setRuntimeParent(_jettag_f_bundle_3_1);
                _jettag_c_if_237_1.setTagInfo(_td_c_if_237_1);
                _jettag_c_if_237_1.doStart(context, out);
                while (_jettag_c_if_237_1.okToProcessBody()) {
                    RuntimeTagElement _jettag_f_message_238_1 = context.getTagFactory().createRuntimeTag(_jetns_f, "message", "f:message", _td_f_message_238_1); //$NON-NLS-1$ //$NON-NLS-2$
                    _jettag_f_message_238_1.setRuntimeParent(_jettag_c_if_237_1);
                    _jettag_f_message_238_1.setTagInfo(_td_f_message_238_1);
                    _jettag_f_message_238_1.doStart(context, out);
                    JET2Writer _jettag_f_message_238_1_saved_out = out;
                    while (_jettag_f_message_238_1.okToProcessBody()) {
                        out = out.newNestedContentWriter();
                        out.write("generated.comment");  //$NON-NLS-1$        
                        _jettag_f_message_238_1.handleBodyContent(out);
                    }
                    out = _jettag_f_message_238_1_saved_out;
                    _jettag_f_message_238_1.doEnd();
                    out.write("\t");  //$NON-NLS-1$        
                    out.write(NL);         
                    ...
                    out.write("\t}");  //$NON-NLS-1$        
                    out.write(NL);         
                    _jettag_c_if_237_1.handleBodyContent(out);
                }
                _jettag_c_if_237_1.doEnd();
                out.write("}");  //$NON-NLS-1$        
                out.write(NL);         
