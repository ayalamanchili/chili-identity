...
public class _jet_componentsxml_2 implements JET2Template {

    public _jet_componentsxml_2() {
        super();
    }
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write("\t");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t<core:init jndi-pattern=\"#{ejbName}/local\" debug=\"true\"/>");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t<core:ejb installed=\"true\" />");  //$NON-NLS-1$        
        out.write(NL);         
