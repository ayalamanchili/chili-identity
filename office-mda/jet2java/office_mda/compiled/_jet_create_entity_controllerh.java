...
public class _jet_create_entity_controllerh implements JET2Template {
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$

    public _jet_create_entity_controllerh() {
        super();
    }
    ...
    private static final TagInfo _td_c_replaceStrings_68_30 = new TagInfo("c:replaceStrings", //$NON-NLS-1$
            68, 30,
            new String[] {
                "replace", //$NON-NLS-1$
                "with", //$NON-NLS-1$
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write(NL);         
        out.write(NL);         
        out.write("@interface Create");  //$NON-NLS-1$        
        out.write(context.embeddedExpressionAsString("${$class/@name}", 7, 18)); //$NON-NLS-1$ //$NON-NLS-2$
        out.write("ViewController : UIViewController {");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        while (_jettag_c_replaceStrings_8_1.okToProcessBody()) {
            out = out.newNestedContentWriter();
            out.write(context.embeddedExpressionAsString("${$groupID}", 8, 40)); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        out.write("_entity_");  //$NON-NLS-1$        
        out.write(context.embeddedExpressionAsString("${lower-case($package/@name)}", 8, 78)); //$NON-NLS-1$ //$NON-NLS-2$
        out.write("_");  //$NON-NLS-1$        
        out.write(context.embeddedExpressionAsString("${$class/@name}", 8, 108)); //$NON-NLS-1$ //$NON-NLS-2$
        out.write(" *");  //$NON-NLS-1$        
        out.write(context.embeddedExpressionAsString("${lower-case($class/@name)}", 8, 125)); //$NON-NLS-1$ //$NON-NLS-2$
        out.write(";");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\tid parent;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\tUIView *create");  //$NON-NLS-1$        
        out.write(context.embeddedExpressionAsString("${$class/@name}", 10, 16)); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        RuntimeTagElement _jettag_c_replaceStrings_68_30 = context.getTagFactory().createRuntimeTag(_jetns_c, "replaceStrings", "c:replaceStrings", _td_c_replaceStrings_68_30); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_replaceStrings_68_30.setRuntimeParent(null);
        _jettag_c_replaceStrings_68_30.setTagInfo(_td_c_replaceStrings_68_30);
        _jettag_c_replaceStrings_68_30.doStart(context, out);
        JET2Writer _jettag_c_replaceStrings_68_30_saved_out = out;
        while (_jettag_c_replaceStrings_68_30.okToProcessBody()) {
            out = out.newNestedContentWriter();
            out.write(context.embeddedExpressionAsString("${$groupID}", 68, 69)); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_replaceStrings_68_30.handleBodyContent(out);
        }
        out = _jettag_c_replaceStrings_68_30_saved_out;
        _jettag_c_replaceStrings_68_30.doEnd();
        out.write("_entity_");  //$NON-NLS-1$        
        out.write(context.embeddedExpressionAsString("${lower-case($package/@name)}", 68, 107)); //$NON-NLS-1$ //$NON-NLS-2$
        out.write("_");  //$NON-NLS-1$        
        out.write(context.embeddedExpressionAsString("${$class/@name}", 68, 137)); //$NON-NLS-1$ //$NON-NLS-2$
        out.write(" *");  //$NON-NLS-1$        
        out.write(context.embeddedExpressionAsString("${lower-case($class/@name)}", 68, 154)); //$NON-NLS-1$ //$NON-NLS-2$
        out.write(";");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write(context.embeddedExpressionAsString("${$class/@name}", 71, 24)); //$NON-NLS-1$ //$NON-NLS-2$
