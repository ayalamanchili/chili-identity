...
public class _jet_ejb_jarxml implements JET2Template {

    public _jet_ejb_jarxml() {
        super();
    }
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write(NL);         
        out.write("\t\t\t<interceptor-class>info.yalamanchili.service.validation.ValidationInterceptor");  //$NON-NLS-1$        
        out.write(NL);         
